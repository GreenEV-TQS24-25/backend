...
public class ChargingStationServiceImpl implements ChargingStationService {
    ...
    public ChargingStation updateChargingStation(int operatorId, ChargingStation chargingStation) {
        ...
        if (chargingStation.getLat() != null)
            existingChargingStation.setLat(chargingStation.getLat());

        if (chargingStation.getLon() != null)
            existingChargingStation.setLon(chargingStation.getLon());
    ...
    public boolean deleteChargingStation(int id, int operatorId) {
        ...
        if (chargingStation.getOperator().getId() != operatorId) {
            log.debug("Charging station with id {} does not belong to operator with id {}", id, operatorId);
            return false;
        }
