...
public class UserStepDefinitions {
    ...
    public void i_am_on_user_login_page() {
        CucumberTest.driver.get("http://localhost/login/login");
        CucumberTest.driver.manage().window().setSize(new Dimension(958, 1078));
    }

    @When("I enter user credentials {string} and {string}")
    public void i_enter_user_credentials(String email, String password) {
        CucumberTest.driver.findElement(By.id("email")).click();
        CucumberTest.driver.findElement(By.id("email")).sendKeys(email);
        CucumberTest.driver.findElement(By.id("password")).click();
    ...
    public void i_should_access_user_dashboard() {
        assertTrue("Should be on user dashboard",
                CucumberTest.driver.getCurrentUrl().contains("dashboard"));
    }

    @When("I navigate through the available options")
    public void i_navigate_through_options() {
        CucumberTest.driver.findElement(By.cssSelector("a:nth-child(1) > .bg-card")).click();
        CucumberTest.driver.findElement(By.cssSelector(".bg-card:nth-child(1) a > .inline-flex")).click();
    }

    @When("I interact with workflow elements")
    public void i_interact_with_workflow_elements() {
        CucumberTest.driver.findElement(By.cssSelector(".border-blue-500:nth-child(3)")).click();
        CucumberTest.driver.findElement(By.cssSelector(".border-blue-500:nth-child(8)")).click();
    ...
    public void i_scroll_to_view_content() {
        CucumberTest.js.executeScript("window.scrollTo(0,0)");
    }

    @When("I complete the workflow steps")
    public void i_complete_workflow_steps() {
        CucumberTest.driver.findElement(By.cssSelector(".size-9:nth-child(1)")).click();
        CucumberTest.driver.findElement(By.cssSelector(".inline-flex:nth-child(4)")).click();
        CucumberTest.driver.findElement(By.cssSelector(".inset-0")).click();
        CucumberTest.driver.findElement(By.cssSelector(".bg-card:nth-child(2) > .px-6")).click();
    }
