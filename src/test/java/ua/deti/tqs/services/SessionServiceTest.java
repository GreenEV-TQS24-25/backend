...
class SessionServiceTest {
    ...
    void whenGetAllSessionsByUserId_thenReturnSessions() {
        when(sessionRepository.findAllByVehicle_User_Id(user.getId())).thenReturn(Optional.of(List.of(session)));
    ...
    void whenGetAllSessionsByStationId_thenReturnSessions() {
        ...
        when(sessionRepository.findAllByChargingSpot_Station_Id(anyInt())).thenReturn(Optional.of(List.of(session)));
    ...
    void whenCreateSession_withInvalidChargingSpot_thenReturnNull() {
        when(vehicleRepository.findById(session.getVehicle().getId())).thenReturn(Optional.of(vehicle));
        when(chargingSpotRepository.findById(session.getChargingSpot().getId())).thenReturn(Optional.empty());
